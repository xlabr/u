...
sed -i '8s/p.*1\"/$tpwd/g' /usr/local/etc/trojan/config.json
sed -i '9d' /usr/local/etc/trojan/config.json
sed -i '13s/p.*o/usr/local/etc/acme/g' /usr/local/etc/trojan/config.json
#sed -i '14s/p.*o/usr\/local\/etc\/acme/g' /usr/local/etc/trojan/config.json
